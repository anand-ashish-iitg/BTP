...
def sent2labels(sent):
	...
	return [getNum(Degree) for token, postag, norm, cui, tui, label, start, end,  fileName, Type, Degree, Polarity, Modality, Aspect in sent]
...
# save the classifier
with open('my_dumped_SVMTDegreeclassifier.pkl', 'wb') as fid:
