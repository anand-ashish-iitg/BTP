...
def sent2labels(sent):
	...
	return [getNum(Polarity) for token, postag, norm, cui, tui, label, start, end,  fileName, Type, Degree, Polarity, Modality, Aspect in sent]
...
# save the classifier
with open('my_dumped_SVMPolarityclassifier.pkl', 'wb') as fid:
