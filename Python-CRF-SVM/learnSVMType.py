...
def sent2labels(sent):
	...
	return [getNum(Type) for token, postag, norm, cui, tui, label, start, end,  fileName, Type, Degree, Polarity, Modality, Aspect in sent]
...
# save the classifier
with open('my_dumped_SVMTypeclassifier.pkl', 'wb') as fid:
