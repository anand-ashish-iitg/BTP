...
# load it again
with open('my_dumped_SVMTypeclassifier.pkl', 'rb') as fid:
	...
	for num in  prediction_rbf:
		if(num==-1):
			predicted_labels.append("ASPECTUAL")
		elif(num==1):
			predicted_labels.append("EVIDENTIAL")		
		else:
	...
	f=open("PredictedTagsType.pkl", 'wb')
	pickle.dump(predicted_labels, f)
	f.close()

	f=open("CorrectTagsType.pkl", 'wb')
