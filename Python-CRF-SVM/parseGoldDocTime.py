   ...
   try:
      ...
      for entity in entities:
         ...
         if(type.childNodes[0].data == "EVENT"):
            ...
            DoctimeNode =  properties.getElementsByTagName('DocTimeRel')[0]
            Doctime = DoctimeNode.childNodes[0].data
            spans.append((int(cords[0]),int(cords[1]),Type,Degree,Polarity,ContextualModality,ContextualAspect,Doctime))
